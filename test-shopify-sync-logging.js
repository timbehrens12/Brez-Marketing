...
console.log('');
console.log('3. Database logs (query sync_session_logs table):');
console.log('   SELECT * FROM sync_session_logs WHERE sync_session_id LIKE \'SYNC_%\' ORDER BY created_at DESC LIMIT 50;');
console.log('');
console.log('4. Local storage logs (in browser dev tools):');
