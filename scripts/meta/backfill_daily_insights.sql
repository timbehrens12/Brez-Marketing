-- BACKFILL SCRIPT FOR META DAILY INSIGHTS TABLES
-- This script will populate the daily insights tables with data from meta_ad_insights
-- Run this script in Supabase SQL Editor to fix missing data

-- STEP 1: Backfill meta_ad_daily_insights
-- This will insert any missing records from meta_ad_insights to meta_ad_daily_insights
DO $$
DECLARE
  v_count INTEGER := 0;
BEGIN
