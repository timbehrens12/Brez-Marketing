...
export default function DashboardPage() {
  ...
  // Update the refresh function to run gap detection after refresh
  const refresh = async () => {
    ...
    // Update the refresh timestamp reference
    ...
    try {
      ...
      if (activePlatforms.meta) {
        ...
        // Dispatch a single consolidated refresh event with all necessary details
