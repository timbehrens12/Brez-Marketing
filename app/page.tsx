...
function BrandCountWidget() {
  ...
  return (
    <div className="bg-gradient-to-br from-black/60 to-black/80 border border-white/15 rounded-2xl p-8">
      ...
      <div className="bg-gradient-to-br from-black/80 via-black/80 to-black/80 border-2 border-[var(--brand-red)]/40 rounded-2xl p-8 mb-6 transition-all duration-300 shadow-[0_0_30px_rgba(255,42,42,0.15)]">
        {/* Header Section */}
                ...
                {[
                  ...
                  <div
                    ...
                    className={`relative flex flex-col h-full rounded-2xl transition-all duration-300 group ${
                      plan.popular 
                        ? 'bg-gradient-to-br from-black/90 via-black/90 to-black/90 border-[3px] border-[var(--brand-red)]/60 scale-[1.02] shadow-[0_0_40px_rgba(255,42,42,.3),inset_0_1px_0_rgba(255,42,42,.2)]' 
                        : 'bg-gradient-to-br from-black/80 via-black/80 to-black/80 border-2 border-red-500/30 hover:border-red-500/50 hover:shadow-[0_0_30px_rgba(255,42,42,.1)]'
                    }`}
                  >
                    {plan.popular && (
