           ...
           <header className="py-6 sticky top-0 z-20 relative">
             <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="absolute right-28 sm:right-32 lg:right-36 top-1/2 -translate-y-1/2 flex items-center gap-3">
               <Link href="/dashboard">
                 <Button className="bg-transparent border border-white/20 hover:bg-white/10 text-white" style={{
                   backgroundImage: "linear-gradient(rgba(0,0,0,0.65), rgba(0,0,0,0.85)), url('/crinkled-paper.png')",
                   backgroundSize: "cover",
                   backgroundPosition: "center",
                   backgroundBlendMode: "multiply"
                 }}>
                ...
                {[
                  ...
                  },
                  {
                    ...
                    features: [
                      ...
                      "Outreach CRM (240 emails/mo)",
                      "White-Label Reports & Branding",
                      "Contract Generator AI",
                      "Enhanced Creative Studio (24/mo)",
                      "AI Chatbot (10/day)"
                    ],
                    limitations: [],
                    whiteLabel: true
                  },
                  {
                    ...
                    features: [
                      ...
                      "Outreach CRM (700 emails/mo)",
                      "AI Chatbot (25/day)",
                      "Creative Studio (80/mo)",
                      "Advanced Analytics"
                    ],
                    limitations: [],
                    whiteLabel: true
                  },
                  {
                    ...
                    features: [
                      ...
                      "Lead Generation (800/mo)",
                      "Outreach CRM (2,000 emails/mo)",
                      "AI Chatbot (50/day)",
                      "Creative Studio (160/mo)",
                      "Priority Support"
                    ],
                    limitations: [],
                    whiteLabel: true
                  },
                  {
                    ...
                    features: [
                      ...
                      "Lead Generation (2,400/mo)",
                      "Outreach CRM (7,200 emails/mo)",
                      ...
                      <div className={`p-6 flex flex-col h-full relative z-10 ${plan.name === "Multi-Brand" ? "-mt-2" : ""}`}>
                        ...
                        <div className="flex items-center gap-3 mb-6 min-h-[60px]">
                          <div className="p-2 rounded-lg bg-[var(--brand-red)]/20 border border-[var(--brand-red)]/30 flex-shrink-0">
                            {plan.icon === "custom" ? (
                              <img src={plan.customIconPath} alt={plan.name} className="w-[50px] h-[50px]" style={{ filter: 'brightness(0) saturate(100%) invert(27%) sepia(98%) saturate(7426%) hue-rotate(357deg) brightness(102%) contrast(116%)' }} />
                            ) : (
