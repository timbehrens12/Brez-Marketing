        ...
        <SignIn 
          appearance={{
            elements: {
              ...
              formFieldInput: "bg-[#2a2a2a] border-[#444] text-white focus:ring-2 focus:ring-gray-400 focus:border-gray-400 transition-colors",
              dividerLine: "bg-[#444]",
              ...
              otpCodeFieldInput: "bg-[#2a2a2a] border-[#444] text-white focus:ring-2 focus:ring-gray-400 focus:border-gray-400",
              formHeaderTitle: "text-white text-xl",
              formHeaderSubtitle: "text-gray-300",
              phoneNumberInput: "bg-[#2a2a2a] border-[#444] text-white focus:ring-2 focus:ring-gray-400 focus:border-gray-400",
