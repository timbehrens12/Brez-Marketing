...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    // Clear auth cookie
    const response = NextResponse.redirect('https://www.brezmarketingdashboard.com/settings?tab=brand-management&success=true&backfill=started')
    ...
    return NextResponse.redirect('https://www.brezmarketingdashboard.com/settings?tab=brand-management&error=server_error')
  }
} 