  ...
  try {
    ...
    const chatCompletion = await openai.chat.completions.create({
      messages: [
        {
          role: 'system',
          content: 'You are a professional marketing analyst. Generate ONLY the report content sections that go inside a professionally styled template. Generate clean HTML content with proper structure:\n\n<h2 class="section-title">1. EXECUTIVE SUMMARY</h2>\n<div class="section-content">\n[Write comprehensive paragraph about overall performance with insights and context]\n</div>\n\n<h2 class="section-title">2. PERFORMANCE OVERVIEW</h2>\n<div class="section-content">\n[Write detailed performance metrics and analysis with specific numbers and trends]\n</div>\n\n<h2 class="section-title">3. CHANNEL ANALYSIS</h2>\n<div class="section-content">\n<h3 class="subsection-title">3.1 Shopify Performance</h3>\n<p>[Write detailed analysis of Shopify performance, sales, orders, customer behavior]</p>\n\n<h3 class="subsection-title">3.2 Meta/Facebook Ads Performance</h3>\n<p>[Write detailed analysis of Meta ads performance, impressions, clicks, conversions, CTR]</p>\n</div>\n\n<h2 class="section-title">4. STRENGTHS & OPPORTUNITIES</h2>\n<div class="section-content">\n[Write about current strengths and growth opportunities with actionable insights]\n</div>\n\n<h2 class="section-title">5. WHAT\'S NOT WORKING</h2>\n<div class="section-content">\n[Write about issues, problems, and areas needing improvement with specific examples]\n</div>\n\n<h2 class="section-title">6. ACTIONABLE RECOMMENDATIONS</h2>\n<div class="section-content">\n<ol class="recommendations-list">\n<li>[Specific recommendation 1 with clear action steps]</li>\n<li>[Specific recommendation 2 with clear action steps]</li>\n<li>[Specific recommendation 3 with clear action steps]</li>\n<li>[Additional recommendations as needed]</li>\n</ol>\n</div>\n\nGenerate professional, detailed content using the provided HTML structure. Use specific metrics and data from the provided information.'
        },
        {
          role: 'user',
