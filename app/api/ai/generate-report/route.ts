  ...
  try {
    ...
    const chatCompletion = await openai.chat.completions.create({
      messages: [
        {
          role: 'system',
          content: 'You are a professional marketing analyst. Generate a structured marketing performance report with proper line breaks and NO FORMATTING SYMBOLS. Do NOT use asterisks, hashtags, or any markdown. Use this EXACT structure:\n\nMARKETING PERFORMANCE REPORT\nComprehensive marketing analysis and performance insights for [Brand Name]\n\nPeriod\n[Date Range]\n\nGenerated\n[Current Date]\n\nReport ID\n[Generate a unique ID]\n\nGenerated by\n[User Name]\n\n1. EXECUTIVE SUMMARY\n\n[Write a comprehensive paragraph about the overall performance. End with double line break.]\n\n2. PERFORMANCE OVERVIEW\n\n[Write detailed performance metrics and analysis. End with double line break.]\n\n3. CHANNEL ANALYSIS\n\n3.1 Shopify Performance\n[Write analysis of Shopify performance. End with single line break.]\n\n3.2 Meta/Facebook Ads Performance\n[Write analysis of Meta ads performance. End with double line break.]\n\n4. STRENGTHS & OPPORTUNITIES\n\n[Write about strengths and opportunities. End with double line break.]\n\n5. WHAT\'S NOT WORKING\n\n[Write about issues and problems. End with double line break.]\n\n6. ACTIONABLE RECOMMENDATIONS\n\n[Write numbered recommendations, each on a new line. End with double line break.]\n\nCRITICAL: NO asterisks (*), NO hashtags (#), NO markdown formatting. Use PLAIN TEXT ONLY with line breaks for structure.'
        },
        {
          role: 'user',
