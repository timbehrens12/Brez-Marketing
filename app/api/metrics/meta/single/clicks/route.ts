...
export async function GET(request: NextRequest) {
  try {
    ...
    console.log(`CLICKS SINGLE METRIC API (from meta_campaign_daily_stats): Fetching for brand ${brandId} from ${fromDate} to ${toDate}${isYesterdayPreset ? ' (yesterday preset)' : ''}`)
