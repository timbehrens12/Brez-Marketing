...
import { Trash2, Edit2, Plus, Upload, X, ExternalLink, Save, Check, Info, Camera, Building2, Tag, Briefcase, Image, Users, Share2, Eye, UserX, Clock, Shield, Calendar, User } from "lucide-react"
...
import BrandSharingDialog from "@/components/settings/BrandSharingDialog"
...
function BrandAccessSection({ type, connections }: { type: 'received' | 'shared' | 'share', connections: PlatformConnection[] }) {
  ...
  const loadBrandAccess = async () => {
    ...
    try {
      ...
      // Fetch user information for all users who have brand access
      ...
      const combinedUserIds = [...sharedUserIds, ...brandAccessUserIds]
                  ...
                  <div className="flex items-center gap-2">
                    <div className="w-8 h-8 bg-gradient-to-br from-[#444] to-[#333] rounded-full flex items-center justify-center">
                      <span className="text-sm font-bold text-white">
                        {(access.sharedBy || 'Unknown').charAt(0).toUpperCase()}
                      </span>
                    </div>
                    <span className="text-sm text-gray-300 font-medium">
                      {access.sharedBy || 'Unknown User'}
                    </span>
                  </div>
                </div>
                ...
                <div className="mb-6 p-6 bg-[#0f0f0f] rounded-xl border border-[#333]">
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between pt-2">
                      <p className="text-sm text-gray-500">Click the buttons below to change permissions:</p>
                      <div className="flex items-center gap-3">
                        <Button
                          variant="outline"
                          size="sm"
...
export default function SettingsPage() {
  ...
  const navigationItems = [
    ...
    },
    {
      ...
      icon: Tag,
      description: 'Manage brands and platforms'
    },
    {
      id: 'brand-access',
      label: 'Brand Access',
      icon: Users,
      description: 'Control shared access'
    },
    {
      id: 'operator-account',
    ...
    <TooltipProvider>
      <div className="min-h-screen bg-gradient-to-br from-[#0f0f0f] to-[#1a1a1a]">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex">
            {/* Sidebar Navigation */}
            <div className="w-80 bg-gradient-to-br from-[#0f0f0f] to-[#1a1a1a] border-r border-[#333] min-h-[calc(100vh-140px)]">
              <div className="p-6">
            ...
            <div className="flex-1 p-6 min-h-[calc(100vh-140px)] overflow-y-auto">
                          ...
                          {agencySettings.agency_logo_url || logoPreview ? (
                            <div className="space-y-3">
                              <div className="relative group">
                                ...
                                <Button
                                  ...
                                  onClick={() => logoPreview ? setLogoPreview(null) : handleLogoChange(null)}
                                  disabled={agencyLoading || isSavingAgency}
                                >
                                  <X className="w-3 h-3" />
                                </Button>
                            ...
                            <div className="space-y-3">
                              <div className="relative group cursor-pointer">
                                <div className="w-full h-36 rounded-xl bg-[#1a1a1a] border-2 border-dashed border-[#333] flex items-center justify-center transition-all duration-200 hover:border-[#444] hover:bg-[#222]">
                      ...
                      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-3">
                          ...
                          {agencySettings.signature_image || signaturePreview ? (
                            <div className="space-y-3">
                              <div className="relative group">
                                ...
                                <Button
                                  ...
                                  size="sm"
                                  className="absolute -top-2 -right-2 w-6 h-6 rounded-full bg-red-500 hover:bg-red-600 text-white p-0 opacity-0 group-hover:opacity-100 transition-opacity"
                                  onClick={() => signaturePreview ? setSignaturePreview(null) : handleSignatureChange(null)}
                                  disabled={agencyLoading || isSavingAgency}
                                >
                                  <X className="w-3 h-3" />
                                </Button>
                            ...
                            <div className="space-y-3">
                              <div className="relative group cursor-pointer">
                                <div className="w-full h-24 rounded-xl bg-[#1a1a1a] border-2 border-dashed border-[#333] flex items-center justify-center transition-all duration-200 hover:border-[#444] hover:bg-[#222]">
                                  <div className="text-center">
                                    ...
                                    <p className="text-white font-medium text-sm mb-1">Upload Signature</p>
                                    <p className="text-gray-400 text-xs">
                                      Your handwritten signature image
                                    </p>
                                  </div>
                                </div>
                                <Input
                  ...
                  <Card className="bg-gradient-to-br from-[#0f0f0f] to-[#1a1a1a] border-[#333] shadow-xl">
                    <CardContent className="pt-4">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-3">
                          {(tempAgencyName !== agencySettings.agency_name || tempAgencyLogo || tempSignatureImage || tempSignatureName !== (agencySettings.signature_name || '')) && (
                      ...
                      <Card className="bg-gradient-to-br from-[#0f0f0f] to-[#1a1a1a] border-[#333] shadow-xl">
                        <CardContent className="p-4">
                          <div className="flex items-center gap-2 mb-2">
                            ...
                            <h3 className="text-white font-medium text-sm">Total Brands</h3>
                          </div>
                      ...
                      <Card className="bg-gradient-to-br from-[#0f0f0f] to-[#1a1a1a] border-[#333] shadow-xl">
                        <CardContent className="p-4">
                          <div className="flex items-center gap-2 mb-2">
                            ...
                            <h3 className="text-white font-medium text-sm">Connected</h3>
                          </div>
                      ...
                      <Card className="bg-gradient-to-br from-[#0f0f0f] to-[#1a1a1a] border-[#333] shadow-xl">
                        <CardContent className="p-4">
                          <div className="flex items-center gap-2 mb-2">
                            ...
                            <h3 className="text-white font-medium text-sm">Owned by You</h3>
                          </div>
                          <p className="text-2xl font-bold text-white">{brands.filter(brand => (brand as any).user_id === user?.id).length}</p>
                        </CardContent>
                      </Card>
                    </div>
                    <Dialog open={isAddBrandDialogOpen} onOpenChange={setIsAddBrandDialogOpen}>
                      <DialogTrigger asChild>
                        <Button className="bg-gradient-to-r from-white to-gray-200 hover:from-gray-100 hover:to-gray-300 text-black font-medium px-4 py-2 rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl">
                      ...
                      <DialogContent className="bg-gradient-to-br from-[#0f0f0f] to-[#1a1a1a] border-[#333] text-white max-w-2xl">
                        ...
                        <div className="flex gap-3 pt-4 border-t border-[#333]">
                          ...
                          <Button 
                            ...
                            variant="outline" 
                            className="border-[#333] bg-transparent text-gray-400 hover:bg-[#1a1a1a] hover:text-white rounded-xl px-6"
                          >
                            Cancel
                          </Button>
                        </div>
                  ...
                  <Card className="bg-gradient-to-br from-[#0f0f0f] to-[#1a1a1a] border-[#333] shadow-xl">
                    <CardHeader className="border-b border-[#333] pb-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <CardTitle className="text-xl font-bold text-white">Your Brands</CardTitle>
                          <p className="text-gray-400 text-sm">Manage brands and their platform connections</p>
                        </div>
                      </div>
                    </CardHeader>
                    <CardContent className="pt-6">
                      {brands.length > 0 ? (
                        ...
                        <div className="text-center py-12">
                          ...
                          <h3 className="text-lg font-semibold text-white mb-2">No brands added yet</h3>
                          <p className="text-gray-400 text-sm mb-4">Create your first brand to start managing campaigns and connections</p>
                          <Button 
              ...
              {activeTab === 'brand-access' && (
                <div className="space-y-6">
                  ...
                  {/* Share New Access Section */}
                  {brands.filter(brand => (brand as any).user_id === user?.id).length > 0 && (
                    <Card className="bg-gradient-to-br from-[#0f0f0f] to-[#1a1a1a] border-[#333] shadow-xl">
                      <CardHeader className="border-b border-[#333] pb-4">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <CardTitle className="text-xl font-bold text-white">Grant Brand Access</CardTitle>
                            <p className="text-gray-400 text-sm">Share your brands with team members and collaborators</p>
                          </div>
                        </div>
                      </CardHeader>
                      <CardContent className="pt-6">
                        <BrandAccessSection type="share" connections={connections} />
                      </CardContent>
                    </Card>
                  )}
