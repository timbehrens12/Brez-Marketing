...
import { Trash2, Edit2, Plus, Upload, X, ExternalLink, Save, Check, Info, Camera, Building2, Tag, Briefcase, Image, Users, Share2, Eye, UserX, Clock, Shield, Calendar, User, FileText, Rocket } from "lucide-react"
            ...
            <div className="bg-[#1a1a1a] border border-[#333] rounded-xl p-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-3 text-xs text-gray-300">
                  <div className="w-6 h-6 bg-[#96BF48]/20 border border-[#96BF48]/30 rounded-full flex items-center justify-center text-[#96BF48] font-bold text-xs">1</div>
                  <span>Redirect to Shopify for secure authorization</span>
                </div>
                <div className="flex items-center gap-3 text-xs text-gray-300">
                  <div className="w-6 h-6 bg-[#96BF48]/20 border border-[#96BF48]/30 rounded-full flex items-center justify-center text-[#96BF48] font-bold text-xs">2</div>
                  <span>Our app automatically installs with read-only permissions</span>
                </div>
                <div className="flex items-center gap-3 text-xs text-gray-300">
                  <div className="w-6 h-6 bg-[#96BF48]/20 border border-[#96BF48]/30 rounded-full flex items-center justify-center text-[#96BF48] font-bold text-xs">3</div>
                  <span>Data syncs instantly - no store changes made</span>
                </div>
              </div>
            </div>

            {/* Security Badge */}
            <div className="bg-gradient-to-r from-emerald-900/20 to-green-900/20 border border-emerald-700/30 rounded-xl p-3">
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 bg-emerald-500/20 rounded-lg flex items-center justify-center">
                  <Shield className="w-4 h-4 text-emerald-400" />
                </div>
                <div>
                  <p className="text-xs font-semibold text-emerald-300">Enterprise-Grade Security</p>
                  <p className="text-xs text-emerald-400/80">OAuth 2.0 • Read-only access • SOC 2 compliant</p>
                </div>
              </div>
            </div>
