              ...
              <p className="text-sm text-gray-400">
                {selectedBrandId && brands.find(b => b.id === selectedBrandId) 
                  ? (() => {
                      ...
                      if (selectedPeriod === "today") {
                        return `Performance reports for ${brandName} - ${availability.reason}${availability.nextAvailable ? ` (${availability.nextAvailable})` : ''}`
                      } else if (selectedPeriod === "last-month") {
                        const monthName = format(dateRange.from!, 'MMMM yyyy')
                        return `Performance reports for ${brandName} (${monthName}) - ${availability.reason}${availability.nextAvailable ? ` (${availability.nextAvailable})` : ''}`
                      }
                      return `Performance reports for ${brandName}`
                    })()
                  : "Select a brand to view comprehensive marketing performance reports"
                }
              </p>
            </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                <Select value={selectedPeriod} onValueChange={handlePeriodSelect}>
                  <SelectTrigger className="w-[140px] bg-[#2A2A2A] border-[#333] text-white hover:bg-[#333]">
                ...
                <Badge variant="outline" className="text-xs bg-[#2A2A2A] border-[#333] text-gray-300">
              ...
              <div className="flex items-center space-x-3">
                {(() => {
                  ...
                  return (
                    <Button 
                      ...
                      size="sm"
                      className={cn(
                        "text-gray-200 bg-[#2A2A2A] border-[#333] hover:bg-[#333] hover:text-white",
                ...
                <Button 
                  variant="outline" 
                  size="sm"
                  className="text-gray-200 bg-[#2A2A2A] border-[#333] hover:bg-[#333] hover:text-white"
                  onClick={exportToPdf}
