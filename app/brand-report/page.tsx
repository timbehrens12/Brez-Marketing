...
export default function BrandReportPage() {
  ...
  const getRefreshAvailability = (periodOverride?: string, brandIdOverride?: string) => {
    ...
    if (checkPeriod === "today") {
      ...
      const hasUsedToday = brandLastGeneration === today || brandDailyReports.length > 0
      ...
      if (brandLastMonthlyGeneration === currentMonthKey) {
        const nextFirst = startOfMonth(addMonths(now, 1))
        return {
          available: false,
          reason: "Monthly report already generated for this brand this month",
