          ...
          {isLoadingReport ? (
            ...
            <div className="p-8 flex justify-center">
              <div className="w-full max-w-4xl bg-[#0f0f0f] rounded-xl border border-[#2A2A2A] overflow-hidden shadow-2xl">
                <div 
                  className="p-8 text-gray-100 leading-relaxed"
                  dangerouslySetInnerHTML={{ 
                    __html: selectedReport.content
                      ...
                      .replace(/(<p class="mb-4 text-gray-300">)(MARKETING PERFORMANCE REPORT)(<\/p>)/g, '<h1 class="text-3xl font-bold mb-2 text-white text-center">$2</h1>')
                      // Style the subtitle
                      .replace(/(<p class="mb-4 text-gray-300">)(Comprehensive marketing analysis.*?)(<\/p>)/g, '<h2 class="text-xl text-center text-gray-400 mb-8">$2</h2>')
                      // Style major sections (1., 2., etc.)
                      .replace(/(<p class="mb-4 text-gray-300">)(\d+\.\s*[A-Z\s&]+)(<\/p>)/g, '<h3 class="text-xl font-bold mb-4 mt-8 text-white border-b border-gray-600 pb-2">$2</h3>')
                      // Style subsections (3.1, 3.2, etc.)
                      .replace(/(<p class="mb-4 text-gray-300">)(3\.\d+\s*[A-Za-z\/\s]+)(<\/p>)/g, '<h4 class="text-lg font-semibold mb-3 mt-6 text-blue-400">$2</h4>')
                      // Style metadata fields (Period, Generated, etc.)
                      .replace(/(<p class="mb-4 text-gray-300">)(Period|Generated|Report ID|Generated by)(<br>)/g, '<div class="mb-2"><span class="font-semibold text-gray-200">$2:</span><br>')
                      .replace(/(<p class="mb-4 text-gray-300">)(Aug \d+, \d+|TESR\w+|Tim Behrens)(<\/p>)/g, '<span class="text-blue-400">$2</span></div>')
                  }}
                />
              </div>
            </div>
