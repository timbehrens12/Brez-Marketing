...
const STYLE_OPTIONS: StyleOption[] = [
  ...
  },
  {
    ...
    category: 'clothing',
    goodFor: 'Shirts, sweaters, jackets, dresses, tops',
    prompt: 'Display this exact clothing item hanging naturally on an appropriate hanger suspended from a dark metal chain against a warm, professional background with DYNAMIC ANGLED POSITIONING - EXACTLY like the reference image style. The entire chain and hanger setup should be positioned at a natural diagonal angle (approximately 10-15 degrees) to create visual interest and dynamic composition. HANGER AND CHAIN SETUP: Show a dark metal chain hanging at an angle from the top of the frame, with a wooden clothing hanger (curved, natural wood finish) suspended from the chain via a metal hook, maintaining the angled positioning. For shirts, t-shirts, sweaters, jackets, blazers, hoodies, dresses, blouses, and similar garments that can hang from the shoulders - use the wooden clothing hanger. For shorts, pants, skirts, and bottoms - use clip hangers with clips at the waistband, but still suspended from the same angled chain system. The clothing should hang naturally with realistic draping and fabric physics at the angled position, showing how the garment would naturally fall when suspended from the angled chain and hanger. EXACT BACKGROUND MATCH: Create the EXACT warm, creamy beige background color as shown in the reference image - this specific soft, neutral beige tone with subtle gradient variations. The background should have the same smooth, matte finish with gentle lighting gradients that create depth and professional studio feel, matching the reference image perfectly. Add realistic shadows behind the angled clothing item - cast a soft, natural shadow on the background wall that follows the contours of the hanging garment at the diagonal angle, positioned to complement the angled positioning and simulate natural lighting. The lighting should be soft and warm, creating gentle highlights on the fabric and natural shadows in the folds while accommodating the angled presentation, matching the lighting style of the reference image. CHAIN AND HANGER DETAILS: The chain should be visible at the top portion of the image at an angle, made of dark metal links, extending down to connect to the wooden hanger. The hanger should be a curved wooden hanger with natural wood grain, similar to the reference image, maintaining the angled positioning. CRITICAL TEXT SPACE: Ensure generous space at the BOTTOM of the image (approximately 25-30% of image height) for text overlays, as the angled chain and hanger area at the top must remain clear. Position the angled hanging garment in the upper 70-75% of the frame, leaving substantial bottom space for text. The garment should be centered horizontally with even spacing on both sides despite the angular positioning. ULTRA-CRITICAL SHAPE PRESERVATION: Preserve the EXACT shape of the clothing item as it would naturally hang at an angle - maintain precise sleeve length, collar shape, hem length, and all structural elements while showing realistic gravity effects and fabric draping at the angled position. CRITICAL PRESERVATION REQUIREMENTS: The clothing color, logo, graphics, text, patterns, fabric texture, and ALL visual elements must be preserved PIXEL-PERFECT and IDENTICAL to the original. Every detail must remain exactly as provided. ULTRA-CRITICAL TEXT PRESERVATION: Preserve ALL text, logos, and graphics with maximum clarity and sharpness. LAYOUT: Portrait format with the angled hanging garment suspended from the angled chain and wooden hanger positioned in the upper portion, leaving generous bottom space for text overlays while maintaining the exact aesthetic of the reference image with matching background color and angled chain setup.'
  }
]
