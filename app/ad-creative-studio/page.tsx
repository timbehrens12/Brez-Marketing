...
const STYLE_OPTIONS: StyleOption[] = [
  ...
  // HANGER STUDIO TEMPLATES - Professional hanger display with warm backgrounds
  {
    id: 'hanger-studio',
    name: 'Hanger Studio',
    description: 'Professional clothing display on hangers with warm lighting and shadows',
    thumbnail: 'https://i.imgur.com/2ZPjGqC.png',
    category: 'clothing',
    goodFor: 'Shirts, sweaters, jackets, dresses, tops',
    prompt: 'Display this exact clothing item hanging naturally on an appropriate hanger against a warm, professional background. HANGER SELECTION LOGIC: For shirts, t-shirts, sweaters, jackets, blazers, hoodies, dresses, blouses, and similar garments that can hang from the shoulders - use a standard clothing hanger (wire or wooden). For shorts, pants, skirts, and bottoms - use clip hangers with clips at the waistband. The clothing should hang naturally with realistic draping and fabric physics, showing how the garment would naturally fall when suspended. Create a warm, inviting background with soft gradient tones in warm colors like cream, beige, soft peach, or warm gray - avoid cold or harsh colors. The background should be softly blurred with a subtle gradient that creates depth and professional studio lighting feel. Add realistic shadows behind the clothing item - cast a soft, natural shadow on the background wall that follows the contours of the hanging garment. The shadow should be subtle but visible, positioned slightly to one side and below the clothing to simulate natural lighting from above and to the side. The lighting should be soft and warm, creating gentle highlights on the fabric and natural shadows in the folds. The hanger should be visible but not distracting - use a simple, professional hanger that complements the garment. CRITICAL TEXT SPACE: Ensure generous space at the BOTTOM of the image (approximately 25-30% of image height) for text overlays, as the hanger chain/hook area at the top must remain clear. Position the hanging garment in the upper 70-75% of the frame, leaving substantial bottom space for text. The garment should be centered horizontally with even spacing on both sides. ULTRA-CRITICAL SHAPE PRESERVATION: Preserve the EXACT shape of the clothing item as it would naturally hang - maintain precise sleeve length, collar shape, hem length, and all structural elements. The garment should hang with natural gravity effects and realistic fabric draping. CRITICAL PRESERVATION REQUIREMENTS: The clothing color, logo, graphics, text, patterns, fabric texture, and ALL visual elements must be preserved PIXEL-PERFECT and IDENTICAL to the original. Every detail must remain exactly as provided. ULTRA-CRITICAL TEXT PRESERVATION: Preserve ALL text, logos, and graphics with maximum clarity and sharpness. LAYOUT: Portrait format with the hanging garment positioned in the upper portion, leaving generous bottom space for text overlays while maintaining professional framing and warm studio lighting aesthetic.'
  },
  {
    id: 'hanger-studio-angled',
    name: 'Hanger Studio (Angled)',
    description: 'Professional clothing display on hangers with dynamic angled positioning and warm lighting',
    thumbnail: 'https://i.imgur.com/2ZPjGqC.png',
    category: 'clothing',
    goodFor: 'Shirts, sweaters, jackets, dresses, tops',
    prompt: 'Display this exact clothing item hanging naturally on an appropriate hanger against a warm, professional background with DYNAMIC ANGLED POSITIONING. The entire hanger setup should be positioned at a natural diagonal angle (approximately 10-15 degrees) to create visual interest and dynamic composition. HANGER SELECTION LOGIC: For shirts, t-shirts, sweaters, jackets, blazers, hoodies, dresses, blouses, and similar garments that can hang from the shoulders - use a standard clothing hanger (wire or wooden). For shorts, pants, skirts, and bottoms - use clip hangers with clips at the waistband. The clothing should hang naturally with realistic draping and fabric physics at the angled position, showing how the garment would naturally fall when suspended at an angle. Create a warm, inviting background with soft gradient tones in warm colors like cream, beige, soft peach, or warm gray - avoid cold or harsh colors. The background should be softly blurred with a subtle gradient that creates depth and professional studio lighting feel. Add realistic shadows behind the angled clothing item - cast a soft, natural shadow on the background wall that follows the contours of the hanging garment at the diagonal angle. The shadow should be subtle but visible, positioned to complement the angled positioning and simulate natural lighting. The lighting should be soft and warm, creating gentle highlights on the fabric and natural shadows in the folds while accommodating the angled presentation. The hanger should be visible but not distracting - use a simple, professional hanger that complements the garment and maintains the angled positioning. CRITICAL TEXT SPACE: Ensure generous space at the BOTTOM of the image (approximately 25-30% of image height) for text overlays, as the angled hanger chain/hook area at the top must remain clear. Position the angled hanging garment in the upper 70-75% of the frame, leaving substantial bottom space for text. The garment should be centered horizontally with even spacing on both sides despite the angular positioning. ULTRA-CRITICAL SHAPE PRESERVATION: Preserve the EXACT shape of the clothing item as it would naturally hang at an angle - maintain precise sleeve length, collar shape, hem length, and all structural elements while showing realistic gravity effects and fabric draping at the angled position. CRITICAL PRESERVATION REQUIREMENTS: The clothing color, logo, graphics, text, patterns, fabric texture, and ALL visual elements must be preserved PIXEL-PERFECT and IDENTICAL to the original. Every detail must remain exactly as provided. ULTRA-CRITICAL TEXT PRESERVATION: Preserve ALL text, logos, and graphics with maximum clarity and sharpness. LAYOUT: Portrait format with the angled hanging garment positioned in the upper portion, leaving generous bottom space for text overlays while maintaining professional framing and warm studio lighting aesthetic with dynamic angled composition.'
  }
]
