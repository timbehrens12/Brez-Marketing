...
const STYLE_OPTIONS: StyleOption[] = [
  ...
  // ANGLED/TILTED VERSIONS - Dynamic positioning variants
  {
    ...
    thumbnail: 'https://i.imgur.com/2ZPjGqC.png',
    category: 'clothing',
    goodFor: 'Clothing, apparel, streetwear',
  ...
  },
  {
    ...
    category: 'clothing',
    goodFor: 'Clothing, apparel, streetwear, urban fashion',
    prompt: 'Place this exact clothing item on a realistic asphalt surface background with DYNAMIC ANGLED POSITIONING, similar to urban street photography and streetwear editorials. The clothing should be positioned at a natural diagonal angle (approximately 15-25 degrees clockwise) to create visual interest and dynamic composition, as if it was casually placed or naturally settled at an angle. The garment should maintain natural shadows around the edges to reflect realistic depth while being positioned diagonally across the frame. The background should be a dark gray asphalt road surface with visible texture variations - NOT a perfect smooth surface but with natural imperfections like small pebbles, minor cracks, subtle wear patterns, and realistic asphalt grain that make it look authentically like a real street surface. Include slight dust particles, minor scuff marks, and natural weathering patterns that make it look like genuine asphalt pavement. The lighting should be natural but directional with subtle variations, casting realistic shadows under the angled clothing to show it\'s resting on the asphalt ground. Add natural fabric behavior with authentic wrinkles, creases, and slight variations in how the fabric sits at the diagonal angle - avoid making it look artificially perfect or too smooth. The clothing should have natural weight distribution and realistic contact points with the asphalt surface while maintaining the angled positioning. Maintain the natural folds, wrinkles, and garment proportions as if it was gently laid down by hand at a natural diagonal angle with natural imperfections. Avoid any artificial floating effect or overly perfect positioning — it must look like a real photograph taken in natural lighting conditions with authentic street surface inconsistencies. CRITICAL SIZING REQUIREMENTS: Position the clothing item with proper framing and breathing room - the garment should fill approximately 60-70% of the frame width, leaving comfortable space on the sides. Ensure generous spacing at top and bottom (approximately 15-20% of image height on each side) for text overlays and visual balance. The product should be prominently displayed but not overly zoomed in, maintaining an aesthetic distance similar to professional product photography with proper margins and visual breathing room. ULTRA-CRITICAL SHAPE PRESERVATION: Do your absolute best to preserve the EXACT shape of the clothing item - if it\'s a shirt, maintain the EXACT sleeve length and precise sleeve shape including ANY layered sleeve combinations (like short sleeves over long sleeves), complex sleeve constructions, sleeve cuffs, sleeve proportions, collar shape, and overall silhouette. CRITICAL: Copy the exact sleeve length - if sleeves end at the wrist, keep them at the wrist; if they\'re 3/4 length, keep them 3/4 length; if they\'re short sleeves, keep them short. If it\'s pants, preserve the exact leg shape, waistband, and proportions. If it\'s any garment, maintain the EXACT original shape including PRECISE SLEEVE LENGTH AND SHAPE (copy exact sleeve proportions, cuff positions, and any layered sleeve designs), hems, collars, pockets, and all structural elements. DO NOT alter, distort, or change the fundamental shape or silhouette of the garment in any way. CRITICAL PRESERVATION REQUIREMENTS: The clothing color, logo, graphics, text, patterns, fabric texture, and ALL visual elements must be preserved PIXEL-PERFECT and IDENTICAL to the original. DO NOT alter, reinterpret, stylize, or change ANY aspect of the product including small details, characters, symbols, or graphics. Every logo, graphic element, text character, and design detail must remain EXACTLY as provided - same colors, same clarity, same positioning. EXTREME BLUE COLOR ACCURACY: If the clothing contains ANY blue colors, tones, or blue-tinted elements, they MUST be preserved with EXACT color fidelity - do not shift hues, change saturation, or alter the blue tones in any way. Blue graphics, logos, or design elements must remain precisely the same shade and intensity. ANTI-DISTORTION PROTECTION: Do not warp, stretch, compress, or geometrically distort ANY part of the clothing - maintain perfect proportional accuracy and shape integrity throughout the entire garment. ULTRA-CRITICAL TEXT PRESERVATION: Pay EXTREME attention to preserving ALL text including the smallest text, size tags, care labels, neck prints, brand names, and any text on tags or labels. These MUST be rendered with MAXIMUM clarity and sharpness - never blur, pixelate, or reduce the quality of ANY text elements no matter how small. NECK TAG TEXT CRITICAL: Pay special attention to neck tag text which is often small and gets distorted - ensure neck tag brand names, logos, and text are preserved with CRYSTAL-CLEAR readability and ZERO distortion. This includes tiny size numbers, care instruction text, brand text on neck tags, and any microscopic text anywhere on the garment. Never allow neck tag text to become blurry, pixelated, or illegible. ULTRA-CRITICAL NO FAKE CONTENT RULE: DO NOT CREATE, ADD, INVENT, OR IMAGINE ANY CONTENT THAT IS NOT ACTUALLY VISIBLE IN THE ORIGINAL IMAGE. This includes: NO fake neck tags, NO fake brand names, NO fake size labels, NO fake care instructions, NO fake logos, NO fake text of any kind. SPECIFICALLY PROHIBITED: Never add "PROJECT CAPRI" or any other test brand names, never create fictional text on clothing. If the original clothing item is a plain garment with no visible tags, text, or graphics, then keep it completely plain. DO NOT add any fictional content whatsoever. SMALL TEXT PRESERVATION: Pay special attention to preserving any small text or brand names that actually exist in the original - these must remain crystal clear, perfectly readable, and NEVER distorted, blurred, or altered. Maintain exact font style, letter spacing, and text clarity. CRITICAL TAG/LABEL RULE: ONLY preserve tags, labels, and text that are ACTUALLY VISIBLE in the original image - DO NOT create, add, or invent any tags, labels, or text that are not present in the source image. If there are visible clothing tags, brand labels, size tags, care labels, or any text/branding on the garment, preserve them EXACTLY as shown with crystal-clear readability. If there are NO visible tags or labels in the original, DO NOT add any. Never fabricate or imagine tags that aren\'t there. Only copy what actually exists in the source image. LAYOUT: Position the product at a natural diagonal angle (15-25 degrees clockwise) in portrait format with generous and EQUAL spacing above and below for text overlays - ensure top and bottom margins are perfectly balanced with approximately 15-20% of image height on each side. Maintain comfortable side margins with the product filling only 60-70% of frame width for proper visual breathing room and professional framing.'
  },
  {
    id: 'sidewalk-pavement-angled',
    name: 'Sidewalk Pavement (Angled)',
    description: 'Realistic concrete sidewalk with dynamic angled positioning',
    thumbnail: 'https://i.imgur.com/DKCvPOi.png',
    category: 'clothing',
    goodFor: 'Streetwear, casual clothing, urban fashion',
    prompt: 'Place this exact clothing item on a realistic concrete sidewalk pavement background with DYNAMIC ANGLED POSITIONING, similar to authentic urban street photography. The clothing should be positioned at a natural diagonal angle (approximately 15-25 degrees clockwise) to create visual interest and dynamic composition, as if it was casually placed or naturally settled at an angle. The garment should maintain natural shadows around the edges to reflect realistic depth while being positioned diagonally across the frame. The background should be a weathered concrete sidewalk with distinct square sections separated by visible expansion joints and seam lines - exactly like the reference image provided. Include authentic concrete texture with natural aging, slight discoloration between sections, subtle staining, minor surface imperfections, and realistic wear patterns that make it look like a genuine city sidewalk. The concrete should have a natural beige-gray tone with slight color variations between different pavement squares. Add realistic weathering including small cracks within sections, slight settling differences, natural dirt accumulation along seam lines, and authentic urban wear patterns. The lighting should be natural daylight with soft shadows that show the angled clothing is naturally resting on the pavement surface. Include natural fabric behavior with authentic wrinkles, creases, and slight variations in how the fabric sits at the diagonal angle - avoid making it look artificially perfect or too smooth. The clothing should have natural weight distribution and realistic contact points with the concrete surface while maintaining the angled positioning. Maintain the natural folds, wrinkles, and garment proportions as if it was gently laid down by hand at a natural diagonal angle with natural imperfections. The seam lines between concrete sections should be clearly visible and run in a grid pattern, creating authentic sidewalk squares underneath the angled clothing. Avoid any artificial floating effect or overly perfect positioning — it must look like a real photograph taken on an actual city sidewalk with natural lighting and authentic pavement characteristics. CRITICAL SIZING REQUIREMENTS: Position the clothing item with proper framing and breathing room - the garment should fill approximately 60-70% of the frame width, leaving comfortable space on the sides. Ensure generous spacing at top and bottom (approximately 15-20% of image height on each side) for text overlays and visual balance. The product should be prominently displayed but not overly zoomed in, maintaining an aesthetic distance similar to professional product photography with proper margins and visual breathing room. ULTRA-CRITICAL SHAPE PRESERVATION: Do your absolute best to preserve the EXACT shape of the clothing item - if it\'s a shirt, maintain the EXACT sleeve length and precise sleeve shape including ANY layered sleeve combinations (like short sleeves over long sleeves), complex sleeve constructions, sleeve cuffs, sleeve proportions, collar shape, and overall silhouette. CRITICAL: Copy the exact sleeve length - if sleeves end at the wrist, keep them at the wrist; if they\'re 3/4 length, keep them 3/4 length; if they\'re short sleeves, keep them short. If it\'s pants, preserve the exact leg shape, waistband, and proportions. If it\'s any garment, maintain the EXACT original shape including PRECISE SLEEVE LENGTH AND SHAPE (copy exact sleeve proportions, cuff positions, and any layered sleeve designs), hems, collars, pockets, and all structural elements. DO NOT alter, distort, or change the fundamental shape or silhouette of the garment in any way. CRITICAL PRESERVATION REQUIREMENTS: The clothing color, logo, graphics, text, patterns, fabric texture, and ALL visual elements must be preserved PIXEL-PERFECT and IDENTICAL to the original. DO NOT alter, reinterpret, stylize, or change ANY aspect of the product including small details, characters, symbols, or graphics. Every logo, graphic element, text character, and design detail must remain EXACTLY as provided - same colors, same clarity, same positioning. ULTRA-CRITICAL TEXT PRESERVATION: Pay EXTREME attention to preserving ALL text including the smallest text, size tags, care labels, neck prints, brand names, and any text on tags or labels. These MUST be rendered with MAXIMUM clarity and sharpness - never blur, pixelate, or reduce the quality of ANY text elements no matter how small. NECK TAG TEXT CRITICAL: Pay special attention to neck tag text which is often small and gets distorted - ensure neck tag brand names, logos, and text are preserved with CRYSTAL-CLEAR readability and ZERO distortion. This includes tiny size numbers, care instruction text, brand text on neck tags, and any microscopic text anywhere on the garment. Never allow neck tag text to become blurry, pixelated, or illegible. ULTRA-CRITICAL NO FAKE CONTENT RULE: DO NOT CREATE, ADD, INVENT, OR IMAGINE ANY CONTENT THAT IS NOT ACTUALLY VISIBLE IN THE ORIGINAL IMAGE. This includes: NO fake neck tags, NO fake brand names, NO fake size labels, NO fake care instructions, NO fake logos, NO fake text of any kind. SPECIFICALLY PROHIBITED: Never add "PROJECT CAPRI" or any other test brand names, never create fictional text on clothing. If the original clothing item is a plain garment with no visible tags, text, or graphics, then keep it completely plain. DO NOT add any fictional content whatsoever. SMALL TEXT PRESERVATION: Pay special attention to preserving any small text or brand names that actually exist in the original - these must remain crystal clear, perfectly readable, and NEVER distorted, blurred, or altered. Maintain exact font style, letter spacing, and text clarity. CRITICAL TAG/LABEL RULE: ONLY preserve tags, labels, and text that are ACTUALLY VISIBLE in the original image - DO NOT create, add, or invent any tags, labels, or text that are not present in the source image. If there are visible clothing tags, brand labels, size tags, care labels, or any text/branding on the garment, preserve them EXACTLY as shown with crystal-clear readability. If there are NO visible tags or labels in the original, DO NOT add any. Never fabricate or imagine tags that aren\'t there. Only copy what actually exists in the source image. LAYOUT: Position the product at a natural diagonal angle (15-25 degrees clockwise) in portrait format with generous and EQUAL spacing above and below for text overlays - ensure top and bottom margins are perfectly balanced with approximately 15-20% of image height on each side. Maintain comfortable side margins with the product filling only 60-70% of frame width for proper visual breathing room and professional framing.'
  },
  ...
  // HANGER DISPLAY TEMPLATES
  {
    id: 'hanger-display',
    name: 'Hanger Display',
    description: 'Professional clothing display on hangers with warm background and shadows',
    thumbnail: 'https://i.imgur.com/2ZPjGqC.png',
    category: 'clothing',
    goodFor: 'Shirts, jackets, sweaters, dresses, blouses, coats',
    prompt: 'Display this exact clothing item hanging naturally on an appropriate hanger against a warm, professional background. For shirts, sweaters, jackets, dresses, blouses, coats, blazers, and similar upper-body garments: use a standard clothes hanger (wooden or plastic). For shorts, pants, skirts, and bottom garments: use a clip hanger or pants hanger with clips. The hanger should be positioned at the top center, with the clothing hanging naturally with realistic fabric draping and gravity effects. Create a warm, inviting background with soft gradient tones in cream, beige, warm gray, or soft taupe colors. Add a realistic drop shadow behind the hanging garment that shows depth and dimension - the shadow should be soft-edged and naturally positioned as if lit by professional studio lighting. The background should have subtle texture variations to avoid looking flat or digital. Ensure the clothing displays natural wrinkles, fabric behavior, and authentic draping as it would hang in a real closet or store display. The lighting should be warm and even, highlighting the garment\'s texture and details while maintaining the professional retail display aesthetic. Keep any text overlays limited to the bottom portion of the image only, as the hanger and chain will occupy the top area. The overall composition should feel like a high-end retail or e-commerce product display. CRITICAL SIZING REQUIREMENTS: Position the hanging clothing item with proper framing and breathing room - the garment should fill approximately 60-70% of the frame width, leaving comfortable space on the sides. Ensure generous spacing at the bottom (approximately 20-25% of image height) for text overlays and visual balance, while keeping the hanger visible at the top. The product should be prominently displayed but not overly zoomed in, maintaining an aesthetic distance similar to professional retail photography with proper margins and visual breathing room. ULTRA-CRITICAL SHAPE PRESERVATION: Do your absolute best to preserve the EXACT shape of the clothing item - if it\'s a shirt, maintain the EXACT sleeve length and precise sleeve shape including ANY layered sleeve combinations, complex sleeve constructions, sleeve cuffs, sleeve proportions, collar shape, and overall silhouette as it would naturally hang. CRITICAL: Copy the exact sleeve length and shape as they would appear when hanging - if sleeves are long, keep them long; if they\'re short sleeves, keep them short. Preserve the exact garment proportions, hems, collars, pockets, and all structural elements as they would naturally drape when hanging. DO NOT alter, distort, or change the fundamental shape or silhouette of the garment in any way. CRITICAL PRESERVATION REQUIREMENTS: The clothing color, logo, graphics, text, patterns, fabric texture, and ALL visual elements must be preserved PIXEL-PERFECT and IDENTICAL to the original. DO NOT alter, reinterpret, stylize, or change ANY aspect of the product. Every logo, graphic element, text character, and design detail must remain EXACTLY as provided. ULTRA-CRITICAL TEXT PRESERVATION: Pay EXTREME attention to preserving ALL text with MAXIMUM clarity and sharpness. ULTRA-CRITICAL NO FAKE CONTENT RULE: DO NOT CREATE, ADD, INVENT, OR IMAGINE ANY CONTENT THAT IS NOT ACTUALLY VISIBLE IN THE ORIGINAL IMAGE. LAYOUT: Position the hanging product in portrait format with the hanger visible at the top, generous spacing at the bottom for text overlays (20-25% of image height), and comfortable side margins with the hanging garment filling 60-70% of frame width for proper visual breathing room and professional retail display framing.'
  },
  {
    id: 'hanger-display-angled',
    name: 'Hanger Display (Angled)',
    description: 'Professional clothing display on hangers with dynamic angled positioning and warm background',
    thumbnail: 'https://i.imgur.com/2ZPjGqC.png',
    category: 'clothing',
    goodFor: 'Shirts, jackets, sweaters, dresses, blouses, coats',
    prompt: 'Display this exact clothing item hanging naturally on an appropriate hanger with DYNAMIC ANGLED POSITIONING against a warm, professional background. For shirts, sweaters, jackets, dresses, blouses, coats, blazers, and similar upper-body garments: use a standard clothes hanger (wooden or plastic). For shorts, pants, skirts, and bottom garments: use a clip hanger or pants hanger with clips. Position the entire hanger and garment at a subtle diagonal angle (approximately 10-20 degrees) to create visual interest and dynamic composition, as if the hanger was naturally positioned at an angle. The clothing should hang naturally with realistic fabric draping and gravity effects, maintaining authentic garment behavior even when angled. Create a warm, inviting background with soft gradient tones in cream, beige, warm gray, or soft taupe colors. Add a realistic drop shadow behind the angled hanging garment that shows depth and dimension - the shadow should be soft-edged and naturally positioned as if lit by professional studio lighting. The background should have subtle texture variations to avoid looking flat or digital. Ensure the clothing displays natural wrinkles, fabric behavior, and authentic draping as it would hang in a real closet or store display, with the angled positioning adding visual dynamism. The lighting should be warm and even, highlighting the garment\'s texture and details while maintaining the professional retail display aesthetic. Keep any text overlays limited to the bottom portion of the image only, as the hanger and chain will occupy the top area. The overall composition should feel like a high-end retail or e-commerce product display with dynamic visual appeal. CRITICAL SIZING REQUIREMENTS: Position the angled hanging clothing item with proper framing and breathing room - the garment should fill approximately 60-70% of the frame width, leaving comfortable space on the sides. Ensure generous spacing at the bottom (approximately 20-25% of image height) for text overlays and visual balance, while keeping the angled hanger visible at the top. The product should be prominently displayed but not overly zoomed in, maintaining an aesthetic distance similar to professional retail photography with proper margins and visual breathing room. ULTRA-CRITICAL SHAPE PRESERVATION: Do your absolute best to preserve the EXACT shape of the clothing item as it would naturally hang at an angle - maintain the EXACT sleeve length and precise sleeve shape, collar shape, and overall silhouette as it would naturally drape when hanging at a diagonal angle. Preserve exact garment proportions, hems, collars, pockets, and all structural elements as they would naturally appear when hanging at an angle. DO NOT alter, distort, or change the fundamental shape or silhouette of the garment in any way. CRITICAL PRESERVATION REQUIREMENTS: The clothing color, logo, graphics, text, patterns, fabric texture, and ALL visual elements must be preserved PIXEL-PERFECT and IDENTICAL to the original. DO NOT alter, reinterpret, stylize, or change ANY aspect of the product. Every logo, graphic element, text character, and design detail must remain EXACTLY as provided. ULTRA-CRITICAL TEXT PRESERVATION: Pay EXTREME attention to preserving ALL text with MAXIMUM clarity and sharpness. ULTRA-CRITICAL NO FAKE CONTENT RULE: DO NOT CREATE, ADD, INVENT, OR IMAGINE ANY CONTENT THAT IS NOT ACTUALLY VISIBLE IN THE ORIGINAL IMAGE. LAYOUT: Position the angled hanging product in portrait format with the hanger visible at the top, generous spacing at the bottom for text overlays (20-25% of image height), and comfortable side margins with the hanging garment filling 60-70% of frame width for proper visual breathing room and professional retail display framing with dynamic visual appeal.'
  }
]
