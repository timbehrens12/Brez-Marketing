              ...
              {(() => {
                ...
                return (
                  <div className="space-y-6">
                    ...
                    {selectedWeek && (
                      <div className="bg-[#0f0f0f] border border-[#FF2A2A]/50 rounded-lg p-4">
                        ...
                        <div className="space-y-4">
                          ...
                          <div>
                            ...
                            <div className="grid grid-cols-3 gap-2">
                              <div className="bg-[#0A0A0A] rounded-lg p-3 text-center">
                                <div className="text-gray-400 text-xs mb-1">Spend</div>
                                <div className="text-white font-bold text-lg">${selectedWeek.spend?.toFixed(2) || '0.00'}</div>
                              </div>
                              <div className="bg-[#0A0A0A] rounded-lg p-3 text-center">
                                <div className="text-gray-400 text-xs mb-1">Revenue</div>
                                <div className="text-emerald-400 font-bold text-lg">${selectedWeek.revenue?.toFixed(2) || '0.00'}</div>
                              </div>
                              <div className="bg-[#0A0A0A] rounded-lg p-3 text-center">
                                <div className="text-gray-400 text-xs mb-1">ROAS</div>
                                <div className="text-[#FF2A2A] font-bold text-lg">{selectedWeek.roas?.toFixed(2) || '0.00'}x</div>
                              </div>
                              <div className="bg-[#0A0A0A] rounded-lg p-3 text-center">
                                <div className="text-gray-400 text-xs mb-1">Impressions</div>
                                <div className="text-white font-bold">{selectedWeek.impressions?.toLocaleString() || '0'}</div>
                              </div>
                              <div className="bg-[#0A0A0A] rounded-lg p-3 text-center">
                                <div className="text-gray-400 text-xs mb-1">Clicks</div>
                                <div className="text-white font-bold">{selectedWeek.clicks?.toLocaleString() || '0'}</div>
                              </div>
                              <div className="bg-[#0A0A0A] rounded-lg p-3 text-center">
                          ...
                          <div>
                                <h4 className="text-white font-semibold text-sm mb-4 flex items-center gap-2">
                                  ...
                                  Goals Set ({selectedWeek.goals?.length || 0})
                                </h4>
                              ...
                              <div className="grid grid-cols-2 gap-2">
                                {selectedWeek.goals.map((goal: any, goalIndex: number) => (
                                  <div key={goalIndex} className="p-3 bg-[#0A0A0A] rounded-lg border border-[#333]">
                                    <div className="flex items-center gap-2 mb-1">
                                      <span className="px-2 py-0.5 rounded text-[10px] font-medium bg-[#FF2A2A]/20 text-[#FF2A2A]">
                                        {goal.type}
                                      </span>
                                    </div>
                                    <p className="text-white font-medium text-sm mb-1">{goal.title}</p>
                                    <p className="text-gray-400 text-xs leading-tight">{goal.description}</p>
                                  </div>
                                ))}
                              </div>
                            ) : (
                              <div className="p-4 bg-[#0A0A0A] rounded-lg border border-[#333] text-center">
                          ...
                          <div>
                            <h4 className="text-white font-semibold text-sm mb-4 flex items-center gap-2">
                              ...
                              Optimizations Applied ({selectedWeek.optimizationsApplied})
                            </h4>
                            {selectedWeek.optimizationsApplied > 0 ? (
                              <div className="grid grid-cols-2 gap-2">
                                {selectedWeek.actions?.map((action: any, actionIndex: number) => (
                                  <div key={actionIndex} className="p-3 bg-[#0A0A0A] rounded-lg border border-[#333]">
                                    <div className="flex items-center gap-2 mb-1">
                                    ...
                                    <p className="text-gray-400 text-xs leading-tight">{action.description}</p>
                                  </div>
                                )) || (
                                  <div className="p-4 bg-[#0A0A0A] rounded-lg border border-[#333] text-center col-span-2">
