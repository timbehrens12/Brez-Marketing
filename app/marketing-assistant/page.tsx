...
export default function MarketingAssistantPage() {
  ...
  if (isLoadingPage || loading) {
    ...
    <div className="min-h-screen bg-[#0B0B0B] relative" 
       ...
       <div className="w-full px-2 sm:px-4 lg:px-6 py-4 overflow-x-hidden h-screen">
         <div className="grid grid-cols-1 xl:grid-cols-12 gap-3 lg:gap-4 max-w-[1920px] mx-auto h-full">
