      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card className="bg-[#1a1a1a] border-[#333] shadow-lg overflow-hidden">
          ...
          <CardContent className="p-0">
            {isDataLoading ? (
              <div className="flex items-center justify-center h-[140px] bg-[#1a1a1a]">
                <div className="animate-spin rounded-full h-6 w-6 border-t-2 border-b-2 border-white"></div>
              </div>
            ) : sortedProducts.length === 0 ? (
              <div className="flex items-center justify-center h-[140px] text-gray-400 text-sm bg-[#1a1a1a]">
                No inventory data available
              </div>
            ) : (
              <ScrollArea className="h-[140px] bg-[#1a1a1a]">
