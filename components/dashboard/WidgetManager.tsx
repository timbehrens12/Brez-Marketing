    ...
    <>
      ...
      >
        <MetricCard
          ...
          value={`$${safeMetricValue(metrics?.adSpend, 0).toFixed(2)}`}
          change={safeMetricValue(metrics?.adSpendGrowth, 0)}
          loading={isLoading}
        ...
        <MetricCard
          ...
          value={`${safeMetricValue(metrics?.roas, 0).toFixed(1)}x`}
          change={safeMetricValue(metrics?.roasGrowth, 0)}
          loading={isLoading}
          refreshing={isRefreshingData}
          initialLoading={initialDataLoad}
          data={[]}
        ...
        <MetricCard
          ...
          value={safeMetricValue(metrics?.impressions, 0).toLocaleString()}
          change={safeMetricValue(metrics?.impressionGrowth, 0)}
          loading={isLoading}
          refreshing={isRefreshingData}
          initialLoading={initialDataLoad}
          data={[]}
        ...
        <MetricCard
          ...
          value={`${safeMetricValue(metrics?.ctr, 0).toFixed(1)}%`}
          change={safeMetricValue(metrics?.ctrGrowth, 0)}
          loading={isLoading}
          refreshing={isRefreshingData}
          initialLoading={initialDataLoad}
          data={[]}
