...
import { Activity, ShoppingBag, Users, DollarSign, TrendingUp, Package, RefreshCcw, BarChart2, PercentIcon, UserCheck, Layers } from "lucide-react"
    ...
    <div className="space-y-8">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <MetricCard
          ...
          value={metrics.inventoryLevels || 0}
          change={metrics.inventoryGrowth || 0}
          valueFormat="number"
          data={safeMetrics.dailyData}
          loading={isLoading}
          refreshing={isRefreshingData}
            ...
            <CardContent>
              <div className="overflow-x-auto">
                <table className="w-full text-sm text-left text-gray-300">
                  <thead className="text-xs uppercase bg-[#222222]">
                    <tr>
                  ...
                  <tbody>
                    {safeMetrics.topProducts.map((product, index) => (
                      <tr key={product.id} className="border-b border-[#222222]">
