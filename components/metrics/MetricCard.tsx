  ...
  const formatPreviousValue = () => {
    try {
      ...
      if (previousValueFormat === 'currency') {
        ...
        return `${previousValuePrefix}${formatPercentage(num, previousValueDecimals)}${previousValueSuffix}`;
      } else {
        ...
        <CardContent className="p-4 pt-2">
          {loading || refreshing ? (
            ...
            <>
              ...
              {!showPreviousPeriod && !hidePercentageChange && !hideChange && typeof change === 'number' && !isNaN(change) && (
                <div className="flex items-center mt-2">
                            ...
                            <p className="text-gray-300">Previous: {previousValue !== undefined && previousValue !== null ? (
                              previousValueFormat === 'currency' 
                                ...
                                : previousValueFormat === 'percentage'
                                  ...
                                  : `${previousValuePrefix}${previousValue.toLocaleString(undefined, {
                                      minimumFractionDigits: previousValueDecimals,
                                      maximumFractionDigits: previousValueDecimals
                                    })}${previousValueSuffix}`
                            ) : 'N/A'}</p>
