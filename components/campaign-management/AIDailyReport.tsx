            ...
            <div className="bg-[#0f0f0f] border border-[#1a1a1a] rounded-xl p-4 backdrop-blur-sm h-full flex items-center justify-center">
              <div className="text-center">
                <p className="text-sm text-gray-200 leading-relaxed max-w-4xl mx-auto">
                  {report.summary ? report.summary.split('.').slice(0, 3).join('.') + '. Current status: ' + (report.overallHealth === 'healthy' ? 'Performance is stable with good metrics' : report.overallHealth === 'warning' ? 'Attention needed for optimization' : 'Critical issues require immediate action') + '.' : ''}
                </p>
              </div>
            </div>
          </div>
                    ...
                    <CardContent className="p-3">
                      <div className="flex items-start gap-2">
                        ...
                        <p className="text-xs text-gray-300 leading-relaxed flex-1">
                          {priority.split('.').slice(0, 2).join('.') + '. Priority level: ' + (index === 0 ? 'High' : 'Medium') + '.'}
                        </p>
                      </div>
                    </CardContent>
                  </Card>
                  ...
                  <Card key={index} className="bg-[#0f0f0f] border-[#1a1a1a] shadow-lg">
                    <CardContent className="p-3">
                      <div className="flex items-start gap-2">
                        ...
                        <p className="text-xs text-gray-300 leading-relaxed flex-1">
                          {highlight.split('.').slice(0, 2).join('.') + '. Trend: ' + (index === 0 ? 'Improving' : 'Stable') + '.'}
                        </p>
                      </div>
                    </CardContent>
                  </Card>
