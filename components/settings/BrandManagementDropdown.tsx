                          ...
                          <Tooltip>
                              ...
                              <div className={!canManagePlatforms ? "cursor-not-allowed" : ""}>
                                <Button 
                                  ...
                                  onClick={async (e) => { 
                                    ...
                                    try {
                                      setIsMetaSyncing(true);
                                      const response = await fetch('/api/meta/sync-demographics', {
                                        method: 'POST',
                                      ...
                                      if (result.success) {
                                        // Show sync started indicator
                                        setTimeout(() => setIsMetaSyncing(false), 5000);
                                      } else {
                                  ...
                                  disabled={!canManagePlatforms || isMetaSyncing}
                                  className={cn(
                                    "border-[#444] bg-[#0f0f0f] text-blue-400 text-xs py-1 px-2 rounded-md",
                                    canManagePlatforms && !isMetaSyncing ? "hover:bg-[#333] hover:text-blue-300" : "opacity-50"
                                  )}
                                >
                                  {isMetaSyncing ? (
                                    <>
                            ...
                            <TooltipContent className="bg-[#1a1a1a] border-[#333] text-white p-3 max-w-xs">
                              <div className="space-y-1 text-sm">
                                ...
                                <p>Manually trigger demographics data sync</p>
                                <p className="text-xs text-gray-400">Usually takes 2-3 minutes</p>
                              </div>
                            </TooltipContent>
                            {!canManagePlatforms && (
                              <TooltipContent>
