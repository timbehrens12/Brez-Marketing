        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <Select value={editBrandNiche} onValueChange={setEditBrandNiche}>
              ...
              <SelectContent className="bg-[#1a1a1a] border-[#333] text-white w-full max-h-64">
                  ...
                  <div className="border-t border-[#333] p-3">
                    <div className="flex items-start gap-2">
                      ...
                      <div className="text-xs text-gray-300">
                        <p className="font-medium mb-1">Meta Pixel Required</p>
                        <p className="text-gray-400 leading-relaxed">
                          Make sure your Meta Ads account has a pixel installed on your website. 
                          Without a pixel, conversion data like ROAS, conversions, etc. will not be displayed.
                        </p>
                      </div>
                    </div>
                  </div>
