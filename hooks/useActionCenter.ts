// DEPRECATED: This complex hook has been replaced with useSimpleNotifications
...
export function useActionCenter_DEPRECATED(mutedNotifications: {[key: string]: boolean} = {}) {
