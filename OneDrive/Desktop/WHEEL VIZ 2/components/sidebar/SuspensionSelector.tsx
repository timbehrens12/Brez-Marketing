...
// Realistic Fitment Industries suspension data
const FITMENT_SUSPENSION = [
  {
    ...
    price: 1899,
    imageUrl: 'https://i.imgur.com/placeholder-susp1.jpg',
  ...
  },
  {
    ...
    price: 1599,
    imageUrl: 'https://i.imgur.com/placeholder-susp2.jpg',
  ...
  },
  {
    ...
    price: 1399,
    imageUrl: 'https://i.imgur.com/placeholder-susp3.jpg',
  ...
  },
  {
    ...
    rearLift: '4.5"',
    price: 2299,
    imageUrl: 'https://i.imgur.com/placeholder-susp4.jpg',
  ...
  },
  {
    ...
    maxLoad: '5000 lbs',
    price: 899,
    imageUrl: 'https://i.imgur.com/placeholder-susp5.jpg',
  ...
  },
  {
    ...
    price: 499,
    imageUrl: 'https://i.imgur.com/placeholder-susp6.jpg',
  ...
  },
  {
    ...
    damping: 'Mono-tube',
    price: 1299,
    imageUrl: 'https://i.imgur.com/placeholder-susp7.jpg',
  ...
  },
  {
    ...
    price: 1799,
    imageUrl: 'https://i.imgur.com/placeholder-susp8.jpg',
        ...
        >
          ...
          <div className="p-3 space-y-2">
            <div className="text-xs text-neutral-400 space-y-1">
              ...
              {suspension.frontLowering && <div>Front: {suspension.frontLowering}</div>}
              {suspension.rearLowering && <div>Rear: {suspension.rearLowering}</div>}
