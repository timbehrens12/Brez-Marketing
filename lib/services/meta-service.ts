  ...
  try {
    ...
    for (const account of accountsData.data) {
      ...
      try {
        ...
        let insightsUrl = `https://graph.facebook.com/v18.0/${account.id}/insights?fields=account_id,account_name,campaign_id,campaign_name,adset_id,adset_name,ad_id,ad_name,impressions,clicks,spend,actions,action_values,reach,inline_link_clicks&level=ad&access_token=${connection.access_token}`;
