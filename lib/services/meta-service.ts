    ...
    for (const account of accountsData.data) {
      ...
      try {
        ...
        try {
          ...
          console.log(`[Meta] 🔥 Age response:`, JSON.stringify(ageData, null, 2));
          console.log(`[Meta] 🔥 Gender response:`, JSON.stringify(genderData, null, 2));
          console.log(`[Meta] 🔥 Device response:`, JSON.stringify(deviceBreakdownData, null, 2));
          console.log(`[Meta] 🔥 Platform response:`, JSON.stringify(platformData, null, 2));
          console.log(`[Meta] 🔥 Age+Gender response:`, JSON.stringify(ageGenderData, null, 2));
